...
/**
 *  \brief  Enables / disables all output function calls
 *  \param  enable : If set to FALSE all output_set_green and output_set_red calls are disabled
 */
void setOutputEnable(hal_bool_t enable);
#endif
