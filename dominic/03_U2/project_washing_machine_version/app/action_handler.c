...
void ah_motor_on(motor_direction_t motor_direction, motor_speed_t motor_speed)
{
    ...
    if(motor_speed == SLOW)
    {
        PORT_OUTPUT &= MASK_MOTOR_SLOW;
    } 
    else
    {
        PORT_OUTPUT &= MASK_MOTOR_FAST;
    }
}
