...
#define LCD_WAIT            0x1fffu


/* -- Macros (FMC)
 * ------------------------------------------------------------------------- */

#define FMC_PORTD_PINMASK   0xfffbu
#define FMC_PORTE_PINMASK   0xffffu
#define FMC_PORTF_PINMASK   0xf03fu
#define FMC_PORTG_PINMASK   0x363fu
...
static void init_LCD(void)
{
    ...
    for(; wait_for_lcd > 0u; wait_for_lcd--);     
#endif
}
